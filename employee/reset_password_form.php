                        ...
                        <form role="form" action="reset_password_process.php" method="POST">
                            ...
                            <div class="form-group">
                                <label>Employee Full name</label>
                                    <input class="form-control" placeholder="Enter employee full name....." name="name" type="password">
                                </div>

                                <div class="form-group">
                                <label>Address</label>
                                    <input class="form-control" placeholder="Enter address....." name="address" type="password">
                                </div>

                                <div class="form-group">
                                <label>E-mail</label>
                                    <input class="form-control" placeholder="Enter email....." name="email" type="password">
                                </div>
