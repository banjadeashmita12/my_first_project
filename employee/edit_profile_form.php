                                ...
                                <div class="col-lg-6">
                                    <form action="edit_profile_form_process.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <input class="form-control" name="salary" value="<?php echo $row['salary'];?>"  placeholder="Enter salary...." required>
                                       </div>

                                       <div class="form-group">
                                           
                                           <input class="form-control" name="post" value="<?php echo $row['post'];?>"  placeholder="Enter post...." required>
                                       </div>
